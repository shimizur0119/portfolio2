  ...
  return (
    <div {...container}>
      <div {...countBoxContainer}>
        <CountBox side="P" count={count.P} borderSize={borderSize} size={props.size}/>
        <CountBox side="E" count={count.E} borderSize={borderSize} size={props.size}/>
      </div>
      <Layout size={size} borderSize={borderSize}>
        {!end && <SkipMessage inFlag={skipFlag} size={props.size}/>}
        {end && <EndMessage count={count} size={props.size}/>}
        {Cells}
      </Layout>
      <div {...countBoxContainer}>
        <MyButton borderSize={borderSize} func={setRestart} val={restart} size={props.size}/>
      </div>
    </div>
  )
}
